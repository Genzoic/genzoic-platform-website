          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-gray-600 mb-8 leading-relaxed">
                Talk, text, or chat — your AI-powered front desk that works across all customer touchpoints.
              </p>
              <button 
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-4">Connect Channels</h3>
              <p className="text-gray-600 mb-4">Integrate with your existing communication platforms.</p>
            </div>
            <div className="text-center">
              <div className="w-20 h-20 bg-blue-600 rounded-full flex items-center justify-center mx-auto mb-6">
                <span className="text-2xl font-bold text-white">2</span>
              </div>
              <h3 className="text-xl font-semibold text-gray-900 mb-4">AI Learns</h3>
              <p className="text-gray-600 mb-4">The agent learns from interactions to improve performance.</p>
            </div>
            <div className="text-center">
              <div className="w-20 h-20 bg-blue-600 rounded-full flex items-center justify-center mx-auto mb-6">
              ...
              <p className="text-gray-600 mb-4">The agent is ready to handle customer inquiries 24/7.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white rounded-xl p-8 shadow-sm border border-gray-200 hover:shadow-md transition-shadow">
              ...
              <p className="text-gray-600">Always available to assist customers, regardless of time zone or business hours.</p>
            </div>
            <div className="bg-white rounded-xl p-8 shadow-sm border border-gray-200 hover:shadow-md transition-shadow">
              <div className="w-12 h-20 bg-blue-100 rounded-lg flex items-center justify-center mb-6">
                <PhoneCall className="text-blue-600 w-6 h-6" />
              </div>
              <h3 className="text-xl font-semibold text-gray-900 mb-3">Intelligent Call Routing</h3>
              <p className="text-gray-600">Directs calls to the appropriate department or agent based on customer needs.</p>
            </div>
            <div className="bg-white rounded-xl p-8 shadow-sm border border-gray-200 hover:shadow-md transition-shadow">
              <div className="w-12 h-12 bg-blue-100 rounded-lg flex items-center justify-center mb-6">
                <MessageSquare className="text-blue-600 w-6 h-6" />
              </div>
              <h3 className="text-xl font-semibold text-gray-900 mb-3">Email and Chat Support</h3>
              <p className="text-gray-600">Provides support via email and chat, ensuring customers can reach you through their preferred channel.</p>
            </div>
          </div>
        </div>
      </section>
...
export default OmnichannelSupportAgent;
